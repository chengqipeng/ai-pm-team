"""将 update_skill 的 SKILL.md 完整内容同步到数据库

运行方式:
    python scripts/sync_update_skill_to_db.py

功能:
    1. 读取 skills/definitions/update_skill/SKILL.md
...
def main():
    ...
    skill_md_path = os.path.join(
        project_root, "skills", "definitions", "update_skill", "SKILL.md"
    )
