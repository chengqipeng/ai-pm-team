...
| 代码 | 来源 | 问题 |
|------|------|------|
| `src/` | 从原 metarepo-web 迁移的业务代码（已合并到 paas-front-platform） | 使用自建 `src/infra/http.ts`，硬编码 localStorage key，未接入框架层 |
