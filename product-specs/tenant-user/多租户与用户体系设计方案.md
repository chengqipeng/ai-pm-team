...
CREATE TABLE IF NOT EXISTS p_user (
    ...
    -- dbc_array 1~5 VARCHAR(300)[]（多选）
    dbc_array1 VARCHAR(300)[], dbc_array2 VARCHAR(300)[], dbc_array3 VARCHAR(300)[],
    dbc_array4 VARCHAR(300)[], dbc_array5 VARCHAR(300)[],
...
| 扩展列 | dbc_varchar*, dbc_bigint*, dbc_decimal*, dbc_smallint*, dbc_textarea*, dbc_array* | 元数据驱动 | 租户自定义字段 |
