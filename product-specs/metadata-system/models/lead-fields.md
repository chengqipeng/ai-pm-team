...
| 3 | leadChannel | 来源方式 | 单选(2) | VARCHAR | dbc_varchar1 | 获取方式（网站/电话/活动等） | <!-- 修正：dbc_int7→dbc_varchar1 2026-04-28 -->
| 4 | leadQuality | 线索质量 | 单选(2) | VARCHAR | dbc_varchar3 | 质量评级（高/中/低） | <!-- 修正：dbc_int10→dbc_varchar3 2026-04-28 -->
| 5 | leadScore | 线索得分 | 整数(5) | BIGINT | dbc_bigint18 | 线索评分 |
| 6 | bdType | 大数据类型 | 单选(2) | VARCHAR | dbc_varchar4 | 大数据来源分类 | <!-- 修正：dbc_int11→dbc_varchar4 2026-04-28 -->
