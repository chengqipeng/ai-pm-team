...
> 状态：✅ 全部完成（p_user 2026-04-16，p_tenant_data 2026-04-28）
...
3. ✅ TenantData 实体移除 departId 字段，只保留 departApiKey
4. ✅ 回填老数据的 depart_api_key（119 条，无法映射的设为 'root'）— 2026-04-28
5. ✅ 删除 depart_id 列（2000 张分片表）— 2026-04-28
6. ✅ EntityColumnResolver.FIXED_COLUMNS 移除 depart_id
7. ✅ XoqlMetadataService 移除 departId 元数据注册
8. ✅ EntityDataApiService.extractFixed 移除 departId 提取
