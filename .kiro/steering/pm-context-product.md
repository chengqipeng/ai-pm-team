...
| 文档 | 路径 | 内容 |
|:---|:---|:---|
| 元数据设计规范 | repos/apass_new_projects/paas-metarepo-service/METADATA-SPEC.md | 存储、命名、关联、唯一性规范 |
| 元模型设计体系 | repos/apass_new_projects/paas-metarepo-service/METAREPO-METAMODEL-DESIGN.md | 三层架构、四表体系、完整字段定义 |
| 元数据实例设计 | repos/apass_new_projects/paas-metarepo-service/METAREPO-METADATA-DESIGN.md | 大宽表、合并机制、写入流程、Java 类体系 |
| 数据迁移方案 | repos/apass_new_projects/paas-metarepo-service/METAREPO-DATA-MIGRATION.md | 老→新编码转换、db_column 重分配 |
